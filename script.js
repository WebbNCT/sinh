...
function createGift() {
  ...
  const messages = [
    "🎁 happy bạn nhận được một điều ước, bạn hãy ước đi nào hãy nói cho người gửi bạn này cho người ấy biết",
    "🎄 Giáng sinh an lành!",
    "⭐ Mùa giáng sinh ấm áp luôn luôn xinh đẹp",
    "🎅 Ho Ho Ho! Tui là ông già Noel",
    "🎁 Chúc mừng... Bạn đã là người yêu của tui",
    "😘 Làm Người Yêu tui nheeeeeeeeeeeeeeeeee",
  ];
